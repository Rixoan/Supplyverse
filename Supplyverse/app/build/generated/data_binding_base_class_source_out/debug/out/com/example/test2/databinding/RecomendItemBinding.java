...
public final class RecomendItemBinding implements ViewBinding {
  @NonNull
  ...
  private RecomendItemBinding(@NonNull LinearLayout rootView, @NonNull CardView cardViewItem,
      @NonNull ImageView ivItemLogo, @NonNull TextView tvItemName, @NonNull TextView tvItemPrice) {
  ...
  @NonNull
  public static RecomendItemBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static RecomendItemBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.recomend_item, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static RecomendItemBinding bind(@NonNull View rootView) {
    // The body of this method is generated in a way you would not otherwise write.
    // This is done to optimize the compiled bytecode for size and performance.
    int id;
    missingId: {
      id = R.id.card_view_item;
      ...
      return new RecomendItemBinding((LinearLayout) rootView, cardViewItem, ivItemLogo, tvItemName,
          tvItemPrice);
    }
